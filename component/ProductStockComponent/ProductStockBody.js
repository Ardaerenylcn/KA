	...
	return (
		<View style={styles.SellerDistirbutorStockBody}>
			<View style={styles.SellerDistirbutorStockBodyProductArea}>
				...
				<Text
					style={styles.SellerDistirbutorStockBodyProductAreaDistirbutorText}
				>
					{distirbutor}
				</Text>
			</View>
...
const styles = StyleSheet.create({
	...
	SellerDistirbutorStockBodyProductAreaDistirbutorText: { color: colors.grey },
});

export default ProductStockBody;
