...
const Announcement = () => {
  const announcements = [
    ...
    { id: "11", title: "Duyuru 10" },
    { id: "12", title: "Duyuru 11" },
    { id: "13", title: "Duyuru 12" },
  ];
      ...
      <View style={styles.announcementItem}>
        <View style={styles.textContainer}>
          <Text
            numberOfLines={1}
            ellipsizeMode="tail"
            style={[styles.announcementTitle, { fontSize: titleFontSize }]}
          >
            {item.title}
          </Text>
    ...
    <SafeAreaView style={styles.safeAreaView}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        {announcements.map((item) => (
          <View key={item.id}>{renderAnnouncementItem({ item })}</View>
        ))}
      </ScrollView>
    </SafeAreaView>
  );
